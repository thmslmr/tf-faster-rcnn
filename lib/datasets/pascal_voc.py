...
class pascal_voc(imdb):
    def __init__(self, image_set, year, use_diff=False):
        ...
        assert os.path.exists(self._devkit_path), 'VOCdevkit path does \
        not exist: {}'.format(self._devkit_path)
        assert os.path.exists(self._data_path), 'Path does \
        not exist: {}'.format(self._data_path)
    ...
    def _load_image_set_index(self):
        ...
        assert os.path.exists(image_set_file), 'Path does not \
        exist: {}'.format(image_set_file)
    ...
    def _get_default_path(self):
        """
            Return the default path where PASCAL VOC is
    ...
    def _load_rpn_roidb(self, gt_roidb):
        ...
        assert os.path.exists(filename), 'rpn data not \
        found at: {}'.format(filename)
