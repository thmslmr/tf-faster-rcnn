...
def proposal_target_layer(rpn_rois, rpn_scores, gt_boxes, _num_classes):
    """
        ...
        Produces proposal classification labels and
    ...
    return rois, roi_scores, labels, bbox_targets, bbox_inside_weights,
...
def _get_bbox_regression_labels(bbox_target_data, num_classes):
    """
        ...
        This function expands those targets into
        the 4-of-4*K representation used by the network
...
def _sample_rois(all_rois, all_scores, gt_boxes, fg_rois_per_image,
    ...
    # Small modification to the original version where we ensure
    # a fixed number of regions are sampled
