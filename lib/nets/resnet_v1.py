...
def resnet_arg_scope(is_training=True, batch_norm_decay=0.997,
    ...
    with arg_scope([slim.conv2d],
                   ...
                   trainable=is_training, activation_fn=tf.nn.relu,
...
class resnetv1(Network):
    ...
    # Do the first few layers manually, because 'SAME' padding can behave
    # inconsistently for images of different sizes: sometimes 0, sometimes 1
    ...
    def _decide_blocks(self):
        ...
        if self._num_layers == 50:
            self._blocks = [
                resnet_v1_block('block1', base_depth=64,
                                num_units=3, stride=2),
                resnet_v1_block('block2', base_depth=128,
                                num_units=4, stride=2),
                # use stride 1 for the last conv4 layer
                resnet_v1_block('block3', base_depth=256,
                                num_units=6, stride=1),
                resnet_v1_block('block4', base_depth=512,
